...
@Component({
  selector: 'elcp-group-peak-monitoring',
  templateUrl: './group-peak-monitoring.component.html',
  styleUrls: ['./group-peak-monitoring.component.scss']
})
export class GroupPeakMonitoringComponent implements OnInit {
