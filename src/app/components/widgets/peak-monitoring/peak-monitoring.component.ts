...
@Component({
  selector: 'elcp-peak-monitoring',
  templateUrl: './peak-monitoring.component.html',
  styleUrls: ['./peak-monitoring.component.scss']
})
export class PeakMonitoringComponent implements OnInit {
