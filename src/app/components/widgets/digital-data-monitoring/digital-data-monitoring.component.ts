...
@Component({
  selector: 'elcp-digital-data-monitoring',
  templateUrl: './digital-data-monitoring.component.html',
  styleUrls: ['./digital-data-monitoring.component.scss']
})
export class DigitalDataMonitoringComponent implements OnInit {
